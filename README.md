...
When resolving nested fields the library will reuse association fetches that already exist on the query root. In practical terms this means:
...
public class UserService {
    ...
    public UserService(QueryFilterBuilder<User> queryFilterBuilder,
        ...
        this.userFilterTemplate = null; // no-op for example
        this.userSortTemplate = null;   // no-op for example
    }
