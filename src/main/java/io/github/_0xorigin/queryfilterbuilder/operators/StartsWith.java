...
/**
 * A {@link FilterOperator} implementation that handles the 'startsWith' operation (case-sensitive).
 * This operator checks if a string expression starts with a specified substring.
 */
public final class StartsWith implements FilterOperator {
