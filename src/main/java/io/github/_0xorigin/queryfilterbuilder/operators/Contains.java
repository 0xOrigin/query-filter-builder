...
/**
 * A {@link FilterOperator} implementation that handles the 'contains' operation (case-sensitive).
 * This operator checks if a string expression contains a specified substring.
 */
public final class Contains implements FilterOperator {
