...
public abstract class AbstractFilterOperator extends FilterUtils implements FilterOperator {
    ...
    private static final Map<Class<? extends Temporal>, TemporalGroup> temporalGroup = new HashMap<>();
    private static final Map<Class<? extends Temporal>, Function<List<?>, ?>> temporalConverter = new HashMap<>();
    private static final Map<TemporalGroup, Function<Path<?>, Expression<?>>> temporalPath = new HashMap<>();
    private static final Map<TemporalGroup, Function<List<?>, List<? extends Comparable<?>>>> temporalToJdbcType = new HashMap<>();
    ...
    static {
        ...
        addTemporalConverter(LocalDateTime.class, generateTemporalConverter(o -> ((LocalDateTime) o).atZone(ZoneId.systemDefault()).toInstant()));
