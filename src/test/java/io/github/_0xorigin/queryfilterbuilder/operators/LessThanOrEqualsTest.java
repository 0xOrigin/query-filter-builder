...
//
//        Predicate result = lessThanOrEqual.apply(path, cb, values, errorWrapper);
//
...
//
//        assertNotNull(result);
//        verify(cb).lessThanOrEqualTo((Expression<Integer>) path, 10);
//        assertFalse(errorWrapper.getBindingResult().hasErrors());
//    }
//
//    @Test
...
//        when(cb.lessThanOrEqualTo(any(), any(Date.class))).thenReturn(predicate);
//
//        Predicate result = lessThanOrEqual.apply(path, cb, values, errorWrapper);
//
//        assertNotNull(result);
//        verify(cb).lessThanOrEqualTo(any(), eq(Date.from(date.atStartOfDay(ZoneId.systemDefault()).toInstant())));
//        assertFalse(errorWrapper.getBindingResult().hasErrors());
//    }
//
//    @Test
...
//        when(cb.lessThanOrEqualTo(any(), any(Timestamp.class))).thenReturn(predicate);
//
//        Predicate result = lessThanOrEqual.apply(path, cb, values, errorWrapper);
//
//        assertNotNull(result);
//        verify(cb).lessThanOrEqualTo(any(), eq(Timestamp.from(dateTime.atZone(ZoneId.systemDefault()).toInstant())));
//        assertFalse(errorWrapper.getBindingResult().hasErrors());
//    }
//
//    @Test
...
//        when(cb.lessThanOrEqualTo(any(), any(Time.class))).thenReturn(predicate);
//
//        errorWrapper = new ErrorWrapper(bindingResult, new FilterWrapper("", "", Operator.LTE, values));
//        Predicate result = lessThanOrEqual.apply(path, cb, values, errorWrapper);
//
//        assertNotNull(result);
//        verify(cb).lessThanOrEqualTo(any(), eq(Time.valueOf(time)));
//        assertFalse(errorWrapper.getBindingResult().hasErrors());
//    }
//
//    @Test
...
//
//        assertNotNull(result);
//        verify(cb).lessThanOrEqualTo(any(), eq(timestamp));
//        assertFalse(errorWrapper.getBindingResult().hasErrors());
//    }
//
//    @Test
...
//        when(path.as(Comparable.class)).thenReturn((Expression<Comparable>) path);
//        when(cb.lessThanOrEqualTo(any(), any(String.class))).thenReturn(predicate);
//
//        Predicate result = lessThanOrEqual.apply(path, cb, values, errorWrapper);
//
//        assertNotNull(result);
//        verify(cb).lessThanOrEqualTo((Expression<String>) path, "test");
//        assertFalse(errorWrapper.getBindingResult().hasErrors());
//    }
//
//    @Test
