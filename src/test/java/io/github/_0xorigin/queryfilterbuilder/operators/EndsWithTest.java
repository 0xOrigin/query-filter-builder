...
class EndsWithTest {
    ...
    void apply_validListWithSingleElement_returnsPredicate() {
        ...
        Optional<Predicate> result = endsWith.apply(expression, criteriaBuilder, values, filterErrorWrapper);
    ...
    @Test
    void getOperatorConstant_returnsEndsWithOperator() {
        assertThat(endsWith.getOperatorConstant()).isEqualTo(Operator.ENDS_WITH);
    }
}
