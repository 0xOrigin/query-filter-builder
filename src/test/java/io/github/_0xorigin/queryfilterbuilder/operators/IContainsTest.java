...
//
//    private IContains iContainsOperator;
//
//    @BeforeEach
//    void setUp() {
//        iContainsOperator = new IContains();
//    }
//
//    @Test
...
//
//        // Act
//        iContainsOperator.apply(path, criteriaBuilder, values, errorWrapper);
//
//        // Assert
...
//
//        // Act
//        iContainsOperator.apply(path, criteriaBuilder, emptyList, errorWrapper);
//
//        // Assert
...
//
//        // Act
//        iContainsOperator.apply(path, criteriaBuilder, listWithNull, errorWrapper);
//
//        // Assert
//        verify(criteriaBuilder).conjunction();
//        verify(path, never()).as(String.class);
