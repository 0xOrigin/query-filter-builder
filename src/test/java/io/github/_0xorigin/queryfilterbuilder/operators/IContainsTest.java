...
class IContainsTest {
    ...
    void apply_validListWithSingleElement_returnsPredicate() {
        ...
        Optional<Predicate> result = icontains.apply(expression, criteriaBuilder, values, filterErrorWrapper);
    ...
    @Test
    void getOperatorConstant_returnsIContainsOperator() {
        assertThat(icontains.getOperatorConstant()).isEqualTo(Operator.ICONTAINS);
    }
}
