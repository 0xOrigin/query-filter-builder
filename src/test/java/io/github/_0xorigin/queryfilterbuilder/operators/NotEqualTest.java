...
class NotEqualTest {
    ...
    private NotEqual notEqualOperator;

    @BeforeEach
    void setUp() {
        notEqualOperator = new NotEqual();
    }
    ...
    void apply_WithValidSingleValue_ShouldCreateEqualPredicate() {
        ...
        // Act
        notEqualOperator.apply(path, criteriaBuilder, values, errorWrapper);
    ...
    void apply_WithEmptyList_ShouldReturnConjunction() {
        ...
        // Act
        notEqualOperator.apply(path, criteriaBuilder, emptyList, errorWrapper);
    ...
    void apply_WithNullValue_ShouldReturnConjunction() {
        ...
        // Act
        notEqualOperator.apply(path, criteriaBuilder, listWithNull, errorWrapper);
