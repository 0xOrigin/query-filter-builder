...
class IStartsWithTest {
    ...
    void apply_validListWithSingleElement_returnsPredicate() {
        ...
        Optional<Predicate> result = istartsWith.apply(expression, criteriaBuilder, values, filterErrorWrapper);
    ...
    @Test
    void getOperatorConstant_returnsIStartsWithOperator() {
        assertThat(istartsWith.getOperatorConstant()).isEqualTo(Operator.ISTARTS_WITH);
    }
}
